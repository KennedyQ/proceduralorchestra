...
if (__name__ == "__main__"):
	...
	soprano = CSound.Performer(60,79,.45,.45,1.05,72,False,"Major",False)
	alto = CSound.Performer(55,72,.1,.1,2,60,False,"Major",True,1)
	tenor = CSound.Performer(48,67,.1,.1,2,60,False,"Major",True,1)
	bass = CSound.Performer(41,60,.1,.1,2,48,False,"Major",True,1)
